...
public class User {
    ...
    public static void checkLoggedIn(Context context, String spot_id, String req_type) {
        ...
        new CheckLoggedInTask(context, spot_id).execute(new String[]{url, ukey, akey, req_type});
    }
}
